...
def evaluate(parameters):
    ...
    new_pos = torch.vstack([torch.zeros((atoms.get_number_of_atoms() - 1, 3), device = device), x])
...
gs = GenerationStrategy(
    steps=[
        ...
        GenerationStep(
            ...
            max_parallelism=3,
            model_kwargs={"torch_device": device},  # Any kwargs you want passed into the model
