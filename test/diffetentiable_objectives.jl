...
@testitem "Test direct band gap derivative wrt position." begin
    ...
    dfx0 = ForwardDiff.gradient(x -> direct_band_gap(calculator, system, x), x0)
    dfx0_finite = FiniteDiff.finite_difference_gradient(x -> direct_band_gap(calculator, system, x), x0)
